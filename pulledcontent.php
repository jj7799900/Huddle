...
?>      
    ...
    <div class="ColorNav" id="tour">
      <div class="w3-container w3-content w3-padding-64" style="max-width:1200px">
       ...
       <button name="sendbutton" class="w3-circle w3-button fa fa-search" type="submit" onclick="func(0)" id="notifystart" ></button>
...
​
<br/>To upload your content, follow these steps. 
​
<br/>1. Log into your Influencers Profile
<br/>2. Have your content prepared (YouTube Links ready, Chronological course layout, daily titles, course picture, etc)
<br/>3. We recommend starting a new day before the first post
<br/>4. Input Content below
<br/>5. Share about your Huddle to build your Tribe. 
   </p>
      ...
      <?php echo "<h3 class='w3-wide w3-center'><span class='ColText'>Hosted by ". $_SESSION['firstname']." ".$_SESSION['lastname'] ."</span></h3>";
    ?>
...
$conn = null;
 ...
 <form action="newday.php">
 <label class="ColText w3-right w3-padding w3-margin" id="lbl" style="font-weight:bold;">New Day
<button  class="w3-button w3-circle w3-white" id="btnnewday" type='submit' onclick='homepage.php' >+</button>
</form>
	  </label>
 	  </div>
